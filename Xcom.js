const FULLCOVERPERCENT = .05;
const RANDOMGENBOARDMAX = 100;
const BOARDWIDTH = 50;
...
function Soldier(name,imgObject){
	this.name = name;
	this.imgs = imgObject;
	this.xCoor = 0;
	this.yCoor = 0;
	...
	this.move = function(x,y){
		moveObject(this,x,y,this.speed);
		//DrawObject(ctx,this.imgs.runInt(0),this.xCoor,this.yCoor,50,50,this.angle)
	}
	
	this.rotate = function(deg){
		rotateObject(this,deg,this.speed);
		//DrawObject(ctx,this.imgs.runInt(0),this.xCoor,this.yCoor,50,50,this.angle)
	}
...
var a = new AnimationImgs("move",["soldier.png","wall.png","box.png","grass.png"])
var s = new Soldier("bill",new ObjectAnimation([a]))

//moveInterval = setInterval(function(){s.move(300,300);},20)
//rotateInterval = setInterval(function(){s.rotate(270);},20)